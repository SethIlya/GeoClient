...
class KMLUploadApiView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        for kml_file in kml_files:
            try:
                ...
                for placemark in root.findall('.//Placemark'):
                    ...
                    point_name = name_tag.text.strip() if name_tag is not None else "Без имени"
        ...
        message = f'Обработка завершена. Обновлено точек: {total_updated}, не найдено в радиусе: {total_not_found}, пропущено (неоднозначно): {total_skipped}.'
